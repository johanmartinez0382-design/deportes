...
<head>
    ...
    <style>
        ...
        /* Encabezado para la sección "Agregar Nuevo Tipo de Producto" (Línea superior en Verde Lima) */
        .card-header-sport {
        ...
        .registered-types-title .text-dark {
        ...
        /* ================================================= */
        /* Botón 'Agregar tipo' (Remplaza btn-warning) */
        .btn-sport-primary {
            background-color: var(--bs-sport-primary);
            color: var(--bs-sport-text-dark);
            font-weight: bold;
        ...
        /* Botón 'Editar' (Mantenemos btn-info, pero puedes cambiarlo si lo deseas) */
        .btn-info {
...
<body>
    ...
    <div class="container my-5">
        ...
        <h1 class="mb-5 title-sport">Tipos de Productos</h1>
            ...
            <div class="card-body">
                <form action="insert_tipo.php" method="POST" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="nombre" id="nombre" placeholder="Bicicleta de Montaña" class="form-control" required>
                    </div>
                    ...
                    <div class="col-md-2">
                        <input type="submit" value="Agregar tipo" class="btn btn-sport-primary w-100">
                    </div>
                </form>
            </div>
        </div>
        ...
        <div>
            <h2 class="mb-4 text-secondary registered-types-title">
